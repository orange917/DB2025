    ...
    bool satisfyConditions() {
        ...
        for (const auto& cond : fed_conds_) {
            ...
            if (type == TYPE_INT) {
                ...
                switch (cond.op) {
                    case OP_EQ: result = std::fabs(left_float - right_float) <= EPSILON; break;
                    case OP_NE: result = std::fabs(left_float - right_float) > EPSILON; break;
                    case OP_LT: result = left_float - right_float < -EPSILON; break;
                    case OP_GT: result = left_float - right_float > EPSILON; break;
                    case OP_LE: result = left_float - right_float <= EPSILON; break;
                    case OP_GE: result = left_float - right_float >= -EPSILON; break;
                    default: result = false;
                }
